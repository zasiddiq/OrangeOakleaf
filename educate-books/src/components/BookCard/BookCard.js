...
class BookItemComponent extends React.Component {
    ...
    render() {
        ...
        const { id, title, imageLinks = {}, authors = []
        } = bookItem;
                ...
                <li key={id}>
                    <div className="book">
                        <div className="book-top">
                            <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: imageLinks.thumbnail ? `url(${imageLinks.thumbnail})` : '' }}></div>
